...
namespace ZGWUI
{
    public partial class Form1 : Form
    {
        ...
        private void GUIinitialize()
        {
            ...
            comboBoxWriteAttribType.Items.Add("String");
            comboBoxWriteAttribType.Items.Add("Integer");
            comboBoxWriteAttribType.SelectedIndex = 0;
                    ...
                    if (bStringToUint8(textBoxWriteAttribDstEP.Text, out u8DstEndPoint) == true)
                    {
                        if (bStringToUint16(textBoxWriteAttribClusterID.Text, out u16ClusterID) == true)
                        {
                            if (bStringToUint16(textBoxWriteAttribID.Text, out u16AttribID) == true)
                            {
                                ...
                                {
                                    if (comboBoxWriteAttribType.SelectedIndex == 1)
                                    {
                                    ...
                                    else if (comboBoxWriteAttribType.SelectedIndex == 2)
                                    {
                                        UInt16 u16Data;
        ...
        private void sendAddScene(byte u8DstAddrMode, UInt16 u16ShortAddr, byte u8SrcEndPoint, byte u8DstEndPoint, UInt16 u16GroupId, byte u8SceneId, UInt16 u16TransTime, String sName, byte u8NameLen, byte u8NameMaxLen, UInt16 u16SceneLength, string stringSceneData)
        {
            byte[] commandData = null;
            commandData = new byte[32];
            byte u8Len = 0;
        ...
        private void displayDecodedCommand(UInt16 u16Type, UInt16 u16Length, byte[] au8Data)
        {
            ...
            switch (u16Type)
            {
                ...
                case 0x8015:
                {
                    ...
                    richTextBoxMessageView.Text += "  Short Address: 0x" + u16ShortAddr.ToString("X4");
                    richTextBoxMessageView.Text += "\n";
                    richTextBoxMessageView.Text += "  Channel: " + au8Data[5];
                    richTextBoxMessageView.Text += "\n";
                ...
                case 0x8029:
                {
                    ...
                    richTextBoxMessageView.Text += "\n";
                    richTextBoxMessageView.Text += "  Channel: " + au8Data[37];
                    richTextBoxMessageView.Text += "\n";
                    richTextBoxMessageView.Text += "  PAN ID: " + u16PANID.ToString("X4");
                    richTextBoxMessageView.Text += "\n";
        ...
        private void comboBoxWriteAttribType_MouseHover(object sender, EventArgs e)
        {
            showToolTipWindow("Attribute Type (String, Integer)");
        }

        private void comboBoxWriteAttribType_MouseLeave(object sender, EventArgs e)
        {
            hideToolTipWindow();
        }
        #endregion
